    ...
    <div className='App'>
      ...
      <div style={{ position: 'absolute', overflow: 'hidden', width: '100%', height: '100%', pointerEvents: 'none' }}>
        ...
        <motion.img alt="planet_yellow_small_1" src={planet_yellow_small}
          style={{ position: 'absolute', left: '2vw', top: '7vw', height: '3.5vw', y: -offsetY * 1.5 }}
          // initial={{ scale: 0 }}
          // animate={{ rotate: -360, scale: 1 }}
          // transition={{
          //   type: "spring",
        ...
        <motion.img alt="falling" src={falling}
          style={{ position: 'absolute', left: '4vw', top: '18vw', height: '9vw', opacity: 1 - offsetY * 0.03, y: offsetY * 15, x: offsetY * 20 }}
          initial={{ scale: 0 }}
          animate={{ rotate: 360, scale: 1 }}
          transition={{
            type: "spring",
        ...
        <motion.img alt="planet_blue_small" src={planet_blue_small}
        ...
        >
          <motion.img alt="planet_blue_v2" src={planet_blue_v2}
            style={{ position: 'absolute', left: '14vw', top: '28vw', height: '6.5vw', opacity: 1 - offsetY * 0.005, y: offsetY * 1.2, x: -offsetY * 1.4, rotate: -0.5 * offsetY }}
        ...
        {/* <h1 style={{ position: 'absolute', fontSize: '5vw', letterSpacing: '0.3em', left: '25vw', top: '15vw', color: 'white' }} >HELLO THERE</h1>
        <h1 style={{ position: 'absolute', fontSize: '2vw', letterSpacing: '0.93em', left: '25.5vw', top: '23vw', color: 'white' }} >WELCOME TO MY CV</h1> */}
        ...
        <motion.img alt="planet_blue_rings" src={planet_blue_rings}
          style={{ position: 'absolute', right: '9vw', top: '10vw', height: '10vw', y: -offsetY * 0.7 }}
          initial={{ scale: 0 }}
          animate={{ rotate: 360, scale: 1 }}
          transition={{
            type: "spring",
        ...
        >
          <motion.img alt="planet_yellow_v2" src={planet_yellow_v2}
            style={{ position: 'absolute', right: '18vw', top: '20vw', height: '4vw', opacity: 1 - offsetY * 0.005, y: offsetY * 1.7, x: offsetY * 1.1, rotate: 0.7 * offsetY }}
            transition={{
              type: "spring",
              stiffness: 200,
              damping: 15
        ...
        <motion.img alt="planet_yellow" src={planet_yellow}
          style={{ position: 'absolute', left: '3vw', top: '37vw', height: '7vw', opacity: 1 - offsetY * 0.01, y: offsetY * 1.5, x: offsetY * 1.2 }}
          initial={{ scale: 0 }}
          animate={{ rotate: -360, scale: 1 }}
          transition={{
            type: "spring",
        ...
        <motion.img alt="planet_pink_yellow_small" src={planet_pink_yellow_small}
          style={{ position: 'absolute', right: '10vw', top: '30vw', height: '6vw', opacity: 1 - offsetY * 0.005, y: offsetY * 1.7, x: offsetY * 1.1, rotate: 0.7 * offsetY }}
